# -*- coding: utf-8 -*-
#
# Cling documentation build configuration file, created by
...
project = u'Cling'
copyright = u'2007-%d, The Cling Team' % date.today().year
...
latex_documents = [
  ('index', 'Cling.tex', u'Cling Documentation',
   u'The Cling Team', 'manual'),
]
...
#man_page_authors = u'Maintained by the Cling Team (<http://compiler-research.org>)'
...
texinfo_documents = [
  ('index', 'Cling', u'Cling Documentation',
   u'The Cling Team', 'Cling', 'One line description of project.',
   'Miscellaneous'),
]
